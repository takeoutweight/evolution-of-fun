...
(def *processing-version* {:major 1 :minor 1 :incremental 0})

#_(let [version-stream (.getResourceAsStream (clojure.lang.RT/baseLoader)
...
(defn domap [fn seq] (doall (map fn seq)))